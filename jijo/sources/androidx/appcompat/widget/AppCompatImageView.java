...
public class AppCompatImageView extends ImageView {
    ...
    public final boolean hasOverlappingRendering() {
        return ((((ImageView) this.f271b.f14790b).getBackground() instanceof RippleDrawable) ^ true) && super.hasOverlappingRendering();
    }
    ...
    public void setImageDrawable(Drawable drawable) {
        b0 b0Var = this.f271b;
        if (b0Var != null && drawable != null && !this.f272d) {
            b0Var.f14789a = drawable.getLevel();
        }
        super.setImageDrawable(drawable);
        if (b0Var != null) {
            b0Var.a();
            if (this.f272d || ((ImageView) b0Var.f14790b).getDrawable() == null) {
                return;
            }
