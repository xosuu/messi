    ...
    public static void main(String[] strArr) {
        ...
        try {
            ...
            if (str == null || str.indexOf("=") != -1) {
                Class clsClass$ = class$org$jasypt$intf$cli$JasyptPBEStringEncryptionCLI;
                if (clsClass$ == null) {
                    clsClass$ = class$("org.jasypt.intf.cli.JasyptPBEStringEncryptionCLI");
                    class$org$jasypt$intf$cli$JasyptPBEStringEncryptionCLI = clsClass$;
                }
            ...
            CLIUtils.showOutput(jasyptStatelessService.encrypt(property, argumentValues.getProperty("password"), null, null, argumentValues.getProperty("algorithm"), null, null, argumentValues.getProperty("keyObtentionIterations"), null, null, argumentValues.getProperty("saltGeneratorClassName"), null, null, argumentValues.getProperty("providerName"), null, null, argumentValues.getProperty("providerClassName"), null, null, argumentValues.getProperty("stringOutputType"), null, null), verbosity);
        } catch (Throwable th) {
